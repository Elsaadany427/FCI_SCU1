...
var merge = require("merge-stream"); // BrowserSync
...
function modules() {
  // Bootstrap
  var bootstrap = gulp.src('./node_modules/bootstrap/dist/**/*').pipe(gulp.dest('./vendor/bootstrap')); // jQuery
